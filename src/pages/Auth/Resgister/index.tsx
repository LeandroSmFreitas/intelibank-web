  ...
  return (
    <S.Container>
      ...
      <S.ContainerForm onSubmit={handleSubmit(onSubmit)}>
        ...
        <Input placeholder="Insira sua senha novamente" title="Confirme sua senha" type="password" {...register("confirmPassword")} error={errors.confirmPassword?.message}/>
        <Input placeholder="Insira sua senha de transferência" title="Senha de transfêrencia" type="password" {...register("transferPassword")} error={errors.transferPassword?.message}/>
